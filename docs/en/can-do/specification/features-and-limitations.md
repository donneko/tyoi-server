...
- The package is experimental, but the public TypeScript API and documented protocol remain backward compatible throughout v1.x. Backward-compatible additions and fixes may be released, and breaking changes are reserved for v2.0.0
