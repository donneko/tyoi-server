...
Defined in: [server-core/types/public/api.type.ts:9](https://github.com/donneko/tyoi-api-node-server/blob/main/src/server/server-core/types/public/api.type.ts#L9)
