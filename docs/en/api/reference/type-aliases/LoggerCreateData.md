...
Defined in: [server-core/types/server-event.type.ts:4](https://github.com/donneko/tyoi-server/blob/main/src/server/server-core/types/server-event.type.ts#L4)
