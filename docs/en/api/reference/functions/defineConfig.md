...
Defined in: [server-core/config/define-config.ts:28](https://github.com/donneko/tyoi-api-node-server/blob/8fc6549033de1a5f4451d86f6614883350995cac/src/server/server-core/config/define-config.ts#L28)
